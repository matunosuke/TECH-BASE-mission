...
<body>
    ...
    $dsn = 'mysql:dbname=tb220361db;host=localhost';
    $user = 'tb-220361';
    $password = '6RHhw2Khuy';
...
<?php
   ...
   if(isset($_POST['signup'])){
       ...
       if(!empty($_POST['userid2']) && !empty($_POST['password2'])){
           ...
           if (preg_match('/\A(?=.*?[a-z])(?=.*?\d)[a-z\d]{8,100}+\z/i', $_POST['password2'])) {
             $userpassword = password_hash($_POST['password2'], PASSWORD_DEFAULT);
           }else{
